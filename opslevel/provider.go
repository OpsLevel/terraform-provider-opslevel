...
func (p *OpslevelProvider) Resources(context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewTeamPropertyDefinitionResource,
		NewTeamResource,
		NewTeamTagResource,
...
func (p *OpslevelProvider) DataSources(context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewRelationshipDefinitionDataSourceSingle,
		NewRelationshipDefinitionDataSourceMulti,
		...
		NewTeamPropertyDefinitionDataSource,
		NewTeamPropertyDefinitionDataSourcesAll,
		NewTierDataSource,
