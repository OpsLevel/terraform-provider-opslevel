...
func NewCheckServiceConfigurationResourceModel(ctx context.Context, check opslevel.Check) CheckServiceConfigurationResourceModel {
	var model CheckServiceConfigurationResourceModel
...
func (r *CheckServiceConfigurationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var planModel CheckServiceConfigurationResourceModel
	...
	stateModel := NewCheckServiceConfigurationResourceModel(ctx, *data)
