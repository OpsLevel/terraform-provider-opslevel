...
var (
	_ resource.ResourceWithConfigure   = &CheckEndpointResource{}
	_ resource.ResourceWithImportState = &CheckEndpointResource{}
)

func NewCheckEndpointResource() resource.Resource {
	return &CheckEndpointResource{}
}

// CheckEndpointResource defines the resource implementation.
type CheckEndpointResource struct {
	CommonResourceClient
}

type CheckEndpointResourceModel struct {
...
func NewCheckEndpointResourceModel(ctx context.Context, check opslevel.Check, planModel CheckEndpointResourceModel) CheckEndpointResourceModel {
	var stateModel CheckEndpointResourceModel
...
func (r *CheckEndpointResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_check_custom_event"
}

func (r *CheckEndpointResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *CheckEndpointResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var planModel CheckEndpointResourceModel
	...
	stateModel := NewCheckEndpointResourceModel(ctx, *data, planModel)

	tflog.Trace(ctx, "created a check custom event resource")
	resp.Diagnostics.Append(resp.State.Set(ctx, &stateModel)...)
}

func (r *CheckEndpointResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var planModel CheckEndpointResourceModel
...
func (r *CheckEndpointResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var planModel CheckEndpointResourceModel
...
func (r *CheckEndpointResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var planModel CheckEndpointResourceModel
...
func (r *CheckEndpointResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
