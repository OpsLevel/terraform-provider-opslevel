...
and is generated by [Changie](https://github.com/miniscruff/changie).## [August 13, 2024](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.2.3...v1.2.4)
### Bugfix
- Hotfix for bug where AlertSource and InfraResource queries failed because field name should be `ownerLocked` instead of `locked`## [August 02, 2024](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.2.2...v1.2.3)## [August 01, 2024](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.2.1...v1.2.2)
### Bugfix
