...
and is generated by [Changie](https://github.com/miniscruff/changie).## v1.14.1 - [September 25, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.14.0...v1.14.1)
### Fixed
...
* Bump codecov/codecov-action from 7.0.0 to 7.1.1## v1.14.0 - [September 10, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.13.0...v1.14.0)
### Added
...
* Bump google.golang.org/grpc from 1.83.1 to 1.83.2## v1.13.0 - [August 31, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.12.0...v1.13.0)
### Fixed
...
* Bump codecov/codecov-action from 6.0.0 to 7.0.0## v1.12.0 - [July 23, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.11.1...v1.12.0)
### Fixed
...
### Added
* New `opslevel_integration_kubernetes` resource for managing a Kubernetes integration's ETL config (`extract_definition` / `transform_definition`) as code## v1.11.1 - [July 08, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.11.0...v1.11.1)
### Security
...
### Dependency
* Bumped the minimum required Go version from 1.24.0 to 1.25.0. Building the provider from source now requires Go 1.25+.## v1.11.0 - [May 20, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.10.1...v1.11.0)
### Added
...
### Added
* Add system_relationship attribute to opslevel_component_type resource and datasources## v1.9.1 - [April 06, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.9.0...v1.9.1)
### Fixed
* Fixed `opslevel_integration_endpoint` import incorrectly storing empty `type` in state, which caused forced resource replacement on subsequent plans## v1.9.0 - [March 06, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.8.5...v1.9.0)
### Added
* Added `opslevel_team_property_definition` resource and data sources (`opslevel_team_property_definition`, `opslevel_team_property_definitions`)## v1.8.5 - [February 03, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.8.4...v1.8.5)
### Added
* Added support for filtering components on component type## v1.8.4 - [January 29, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.8.3...v1.8.4)
### Fixed
* Corrected 3 instances of OptionalStringValue converting empty strings to null## v1.8.3 - [January 16, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.8.2...v1.8.3)
### Fixed
* retrieve full system data on service
* unescape html for proper use of special characters## v1.8.2 - [January 07, 2026](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.8.1...v1.8.2)## v1.8.1 - [December 17, 2025](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.8.0...v1.8.1)
### Fixed
* allowed relationship properties no longer replace relationships
### Dependency
* opslevel-go v2025.12.17## v1.8.0 - [December 16, 2025](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.7.0...v1.8.0)
### Fixed
...
* Support for component category filter## v1.7.0 - [December 05, 2025](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.6.3...v1.7.0)
### Added
* Added support for allowed categories on relationships
* Added support for relationship management rules## v1.6.3 - [October 22, 2025](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.6.2...v1.6.3)## v1.6.2 - [October 21, 2025](https://github.com/OpsLevel/terraform-provider-opslevel/compare/v1.6.1...v1.6.2)
### Fixed
