...
run "resource_check_code_issue_unset_optional_fields" {
  ...
  assert {
    condition     = opslevel_check_code_issue.this.issue_name == null
    error_message = var.error_expected_null_field
  }

  assert {
    condition     = opslevel_check_code_issue.this.issue_type == null
    error_message = var.error_expected_null_field
  }
  ...
  # assert {
  #   # TODO: API returns empty list or null?
  #   condition     = opslevel_check_code_issue.this.severity == null
  #   error_message = var.error_expected_null_field
  # }

}

run "resource_check_code_issue_update_to_constraint_contains" {
  ...
  variables {
    ...
    enabled    = null
    filter     = null
    issue_name = "test-issue" # required when constraint is "contains"
...
run "resource_check_code_issue_update_to_constraint_exact" {
...
run "resource_check_code_issue_update_to_constraint_any" {
