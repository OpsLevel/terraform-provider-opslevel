...
run "resource_check_service_property_create_with_all_fields" {
  ...
  assert {
    condition = alltrue([
      can(opslevel_check_service_property.test.category),
      can(opslevel_check_service_property.test.description),
      can(opslevel_check_service_property.test.enable_on),
      ...
      can(opslevel_check_service_property.test.owner),
    ])
...
run "resource_check_service_property_update_unset_optional_fields" {
  ...
  assert {
    condition     = opslevel_check_service_property.test.enabled == false
