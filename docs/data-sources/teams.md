...
- `properties` (Attributes List) Custom properties for this team. Includes an entry for every team property definition; `value` is null where the team has no value assigned. (see [below for nested schema](#nestedatt--teams--properties))
...
<a id="nestedatt--teams--properties"></a>
### Nested Schema for `teams.properties`

Read-Only:

- `definition` (Attributes) (see [below for nested schema](#nestedatt--teams--properties--definition))
- `value` (String) The value of the custom property.

<a id="nestedatt--teams--properties--definition"></a>
### Nested Schema for `teams.properties.definition`
